...
author: "Henry Baker, Daniyar Imanaliev, Isabella Urbano Trujillo"
date: "`r Sys.Date()`"
output: 
...
# ...what if you realized you’d been heading in the wrong direction all this time and wanted to run a *different* model? ...you're in trouble!
...
On the follow slides are **three common methods for creating a scatter plot of two numeric variables**. In each separate groups of developers devised three distinct interfaces for the same task. Each has advantages and disadvantages. Each is different!
...
- can be useful to assign "ID" role to variables.
